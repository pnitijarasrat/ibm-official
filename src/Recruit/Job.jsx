...
export default function Job({ id, name, desc, department, period, link, get }) {
      ...
      <div className="job-card">
        <div style={{ width: "80%" }}>
          ...
          <div className="gap">
            ...
            <a href={`/recruit/${id}`} target="_blank" rel="noreferrer">
              <button>View</button>
            </a>
            {!isWriting && (
          ...
          {isWriting && (
            <Form layout="vertical" form={cvForm} style={{ width: "100%" }}>
              <Form.Item
                label="Tell me about yourself. (200 letters)"
                name="cv"
                rules={[{ required: true }]}
              >
